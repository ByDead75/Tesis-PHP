...
<div class="modal fade" id="empresasModal" tabindex="-1" aria-labelledby="Label" aria-hidden="true" 
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
        <div class="modal-content">
            ...
            <div id="spinner-empresas" class="text-center pb-3">
                <div class="spinner-border text-primary" style="width: 6rem; height: 6rem;" role="status">
                    <span class="visually-hidden">Cargando...</span>
                </div>
                <h4 class="text-primary">Cargando...</h4>
...
<div class="modal fade" id="sucursalesModal" tabindex="-1" aria-labelledby="Label" aria-hidden="true" 
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div id="spinner-sucursales" class="text-center pb-3">
                <div class="spinner-border text-primary" style="width: 6rem; height: 6rem;" role="status">
                    <span class="visually-hidden">Cargando...</span>
                </div>
                <h4 class="text-primary">Cargando...</h4>
...
<!-- Modal Centros De Costo segun Empresa -->
<div class="modal fade" id="centroDeCostoEmpresaModal" tabindex="-1" aria-labelledby="Label" aria-hidden="true" 
            data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-scrollable modal-xl">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div id="spinner-centroDeCostoEmpresa" class="text-center pb-3">
                <div class="spinner-border text-primary" style="width: 6rem; height: 6rem;" role="status">
                    <span class="visually-hidden">Cargando...</span>
                </div>
                <h4 class="text-primary">Cargando...</h4>
...
<!-- Modal para mostrar los Bancos al registrar Proveedores -->
<div class="modal fade" id="bancoRegistrarModal" tabindex="-1" aria-labelledby="Label" aria-hidden="true" 
            data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div id="spinner-bancos-registrar" class="text-center pb-3">
                <div class="spinner-border text-primary" style="width: 6rem; height: 6rem;" role="status">
                    <span class="visually-hidden">Cargando...</span>
                </div>
                <h4 class="text-primary">Cargando...</h4>
