...
<div class="error-page container">
    <div class="col-md-8 col-12 offset-md-2">
        <div class="text-center">
            ...
            <h1 class="error-title">Error de Sistema</h1>
            <p class="fs-5 text-gray-600">La página no se encuentra disponible actualmente. 
                Intente de nuevo después.</p>
            <a href="/" class="btn btn-lg btn-outline-primary mt-3">Volver al Inicio</a>
        </div>
    </div>
</div>
