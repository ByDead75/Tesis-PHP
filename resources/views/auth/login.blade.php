                        ...
                        <div class="auth-logo text-center d-md-block d-lg-none h">
                            ...
                            <form method="POST" action="{{ route('usuario.login') }}">
                                ...
                                <div class="form-group position-relative has-icon-left mb-4">
                                    <input type="text" class="form-control form-control-xl" id="cedula" 
                                    name="cedula" placeholder="Usuario">
                                ...
                                <div class="form-check form-check-lg d-flex align-items-end">
                                    ...
                                    <label class="form-check-label text-gray-600" for="flexCheckDefault">Mantener Sesión</label>
                                </div>
                                <button class="btn btn-primary btn-block btn-lg shadow-lg mt-5" type="submit">Confirmar</button>
                            </form>
                        </div>
                    </div>
                    <div class="col-lg-7 d-none d-lg-block">
                        <div id="auth-right">
                            <div class="d-flex align-items-center justify-content-center h-100">
                                <a href="/">
                                    <img src="{{asset('assets/compiled/svg/logo_humanitas.svg')}}" alt="Logo" class="img-fluid img-shadow" width="100%">
                                </a>
                            </div>
                        </div>
                    </div>
