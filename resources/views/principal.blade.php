...
<head>
    ...
    <title>SOP Humanitas</title>
    
    <link rel="shortcut icon" href="{{ asset('assets/compiled/png/humanitas_icono.png')}}" type="image/x-icon">
  ...
  <link rel="stylesheet" href="./assets/compiled/css/footer.css">
  <link rel="stylesheet" href="./assets/compiled/css/button-logout.css">
</head>
...
<body>
        ...
        <div id="main" class="layout-horizontal">
            <header class="mb-5">
                <div class="header-top">
                    <div class="container">
                        <div class="logo">
                            <a href="/template"><img src="./assets/compiled/svg/humanitas.jfif" alt="Logo"></a>
                        </div>
                        <div class="header-top-right">

                            <div>
                                <a href="#" id="topbarUserDropdown" class="d-flex align-items-center">
                                    <div class="avatar avatar-md2">
                                        <img src="./assets/compiled/jpg/1.jpg" alt="Avatar">
                                    </div>
                                    <div class="text">
                                        <h6 class="user-dropdown-name">John Ducky</h6>
                                        <a href="/login" class="user-dropdown-status text-sm text-muted">Logout</a>
                                    </div>
                                </a>
                            </div>
    ...
    <main class="content">
        <h1>Tu Administradora de Fondos de Salud de Confianza</h1>
        <p>Esto es una prueba para organizarnos</p>
        <p>Puedes seleccionar la opción que consideres oportuna</p>
    </main>

    <footer>
        <p>&copy; <?php echo date("Y"); ?> Humanitas Administradora de Riesgos, S.A. Todos los derechos reservados.</p>
    </footer>
